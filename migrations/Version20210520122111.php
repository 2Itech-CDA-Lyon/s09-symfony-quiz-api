 ...
 */
final class Version20210520122111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, right_answer_id INT DEFAULT NULL, text VARCHAR(255) NOT NULL, question_order INT DEFAULT NULL, INDEX IDX_B6F7494E853CD175 (quiz_id), UNIQUE INDEX UNIQ_B6F7494E4C827E5E (right_answer_id), UNIQUE INDEX unique_order_in_quiz (question_order, quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
